...
<body>
 ...
 <div class="container" style="margin-top: 10px">
	...
	<h2>DATA BELANJA (ADM)</h2>
            ...
            <div class="card-body">
	<br/>
	<a href="p_brg.php" class="btn btn-md btn-success" >TAMPILKAN</a> 
	<a href="tambah1.php" class="btn btn-md btn-success" >KEMBALI</a>
	...
	<div class="col-md-6">
		  <div class="form-group ">
				...
				<div>
                  <label>Merk</label>
				   <input type="text" name="merk" placeholder="Masukkan Merk" onkeyup="this.value = this.value.toUpperCase()"
					 class="form-control">	
				</div>
				<div class="form-group">
                  <label>Harga Satuan</label>
