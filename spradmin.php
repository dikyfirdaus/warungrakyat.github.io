...
?>
      <h1 class="logo me-auto"><a href="spradmin.php">SA WarungRakyat</a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <a href="admin.html" class="logo me-auto"><img src="assets/img/logowr1.png" alt="" class="img-fluid"></a>
        ...
        <div class="row no-gutters">
          <div class="col-lg-4 col-md-6">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="konsumen.php">Konsumen</a></h4>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="konsumen.php">Penjualan</a></h4>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="konsumen.php">Top Up</a></h4>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-blue">
              ...
              <h4><a href="data_pesanan.php">Request Product</a></h4>
