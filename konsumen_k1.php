...
<?php 
                  ...
                  ?>
<a style="center" href="kembali.php?id=<?php echo $row2['nik'];?>" class="btn btn-md btn-success" style="margin-bottom: 10px">KELUAR</a>
                  ...
                  ?>
					...
					<tr>
                      ...
                      <td class="text-center">
						...
						<a href="k1.php?id=<?php echo $row['nik'] ?>" class="btn btn-sm btn-primary">EXIT</a>					
                      </td>
                  </tr
				   <?php } ?>
                </tbody>
