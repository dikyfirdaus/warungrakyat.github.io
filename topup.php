...
<body>
 <div class="container" style="margin-top: 10px">
	...
	?> 
	<form method="GET" action="topuptambah.php" id="konsumen">
	...
	<div class="col-md-12">
		  <div class="form-group">
				...
				<button type="submit" class="btn btn-success">TAMBAH UANG</button>
	</form>
	<table class="table table-bordered" id="uang_anggota">
                <thead>
				<tr>
                    <th scope="col">NO.</th>
					<th scope="col">ID</th>
	...
	$join = "select * from uang_anggota join konsumen on konsumen.nik = uang_anggota.nik";
	$no=1;
	$select = mysqli_query($koneksi, $join);
	//$data = mysqli_query($koneksi,"select * FROM penjualan1 where nik='$nik1'");
	
	
	$data1 = mysqli_query($koneksi,"select * FROM uang_anggota where nik='$nik1'");
	...
	while($d = mysqli_fetch_array($data1)){
				  ...
				  <tr>
                      ...
                      <td class="text-center">
                        ...
                        <a href="edit_topup.php?id=<?php echo $d['id'] ?>" class="btn btn-sm btn-primary">EDIT</a>
                        <a href="hapus_topup.php?id=<?php echo $d['id'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
