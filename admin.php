...
include ('koneksidbs.php');
$id=$_GET['nik'];
$q = mysqli_query($koneksi,"select*FROM users where nik='$id'");
$qs1=mysqli_fetch_array($q);

?>
      <h1 class="logo me-auto"><a href=""><?php echo $qs1['kel'];?></a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <a href="" class="logo me-auto"><img src="assets/img/logowr1.png" alt="" class="img-fluid"></a>
        ...
        <div class="row no-gutters">
          <div class="col-lg-4 col-md-6">
            <div class="icon-box">
              ...
              <h4 id="konsumen" class="title"><a href="konsumenkel.php?id=<?php echo $qs1['nik'];?>">Konsumen</a></h4>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="konsumenkel.php?id=<?php echo $qs1['nik'];?>">Penjualan</a></h4>
              <p class="description"> Admin pengelola WarungRakyat sekligus penghubung dengan masyarakat ke tingkat RT.</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="icon-box">
              <div class="icon"><i class="bi bi-calendar4-week"></i></div>
              <h4 class="title"><a href="konsumenkel.php?id=<?php echo $qs1['nik'];?>">Top Up</a></h4>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-blue">
              ...
              <h4><a href="data_pesanan.php?nik=<?php echo $id; ?>">Request Product</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-orange ">
              ...
              <h4><a href="lihat_komp.php?nik=<?php echo $id; ?>">Komplain Layanan</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-pink">
              ...
              <h4><a href="tambah_k1.php">Daftar Sebagai Pengelola</a></h4>
              <p>Siapa saja dapat menjadi pengelola WarungPintar tetapi setiap Rukun Tetangga hanya ada 1 (satu) Pengelola</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-red">
              ...
              <p>Daftar pertanyaan untuk Quick Respond Konsumen atau Pengelola terhadap WarungPintar</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-teal">
              ...
              <p>Berisi berita terkait perkembangan terkini dan lika-liku perjalanan WarungPintar</p>
            </div>
          </div>
