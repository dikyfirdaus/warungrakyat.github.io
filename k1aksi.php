...
</head><body><div align="center" class="tengah"><p align="center"><font face="verdana" size="4" color="black">Pastikan NIK Konsumen</font></p>
<form method="post" action="">
	...
	<div class="col-md-12">
		  ...
		  <table>
			<tr>
				<td>NIK </td>
				<td><input type="text" name="nik" value=<?php echo $r['nik'];?> readonly ></td>
			</tr>
		</table>
				</div>
				</div>
				<button type="submit" class="btn btn-sm btn-danger">Klik untuk lanjut</button>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <h1 <a href="k1.php">Hi....</a></h1>
	 <?php echo $r['nama_k'];
	 
	 ?>
	 
      <!-- Uncomment below if you prefer to use an image logo -->
      <a href="k1.php[" class="logo me-auto"><img src="assets/img/logowp1.png" alt="" class="img-fluid"></a>
        ...
        <div class="row no-gutters">
          <div class="col-lg-4 col-md-6">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="konsumen.php">Profile</a></h4>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="penawaran_adm.php">Penjualan</a></h4>
