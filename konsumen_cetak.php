        ...
        <div class="col-md-15">
          <div class="card">
			...
			<?php 
                  ...
                  ?>
				  <a id='konsumen' href="konsumen.php" class="btn btn-md btn-success" style="margin-bottom: 10px">KEMBALI</a>
				  <a id='konsumen' href="konsumen_cetakxls.php" class="btn btn-md btn-success" style="margin-bottom: 10px">CETAK EXCEL</a>
				  <br/>
	DATA KONSUMEN (ADM)
	 </div>
            <div class="card-body">
