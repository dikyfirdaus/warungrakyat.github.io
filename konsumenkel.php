...
<body>
 <div class="container" style="margin: 10px 10px" >
	...
	<a href="p_brg.php?nik=<?php echo $qs2['nik'] ?>" class="btn btn-md btn-success" style="margin-bottom: 10px">LIHAT DATA BELANJA</a>
	<a id='konsumen' href="admin.php?nik=<?php echo $qs2['nik'] ?>" class="btn btn-md btn-success" style="margin-bottom: 10px">KEMBALI</a>
	<a id='konsumen' href="konsumenkel_cetak.php?nik=<?php echo $qs2['nik'] ?>" class="btn btn-md btn-success" style="margin-bottom: 10px">CETAK</a>
