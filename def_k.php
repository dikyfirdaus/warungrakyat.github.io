...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">KONSUMEN</a></h1>
        ...
        <div class="row no-gutters">
          <div class="col-lg-12 col-md-12">
            <div class="icon-box" align="center">
              ...
              <p class="description">Merupakan anggota WarungRakyat sebagai klient yang bekerjasama dalam wilayah lingkungan Rukun Tetangga. Untuk dapat menggunakan aplikasi, terlebih dahulu calon anggota melakukan registrsi serta dilanjutkan mengisi Bio Data agar terdaftar dalam database.
			  Apabila tidak mengisi Bio data maka aplikasi WarungRakyat tidak dapat melayaninya.</p>
            </div>
          </div>
          </div>
		  <div class="row no-gutters">
          <div class="col-lg-12 col-md-12">
            <div class="icon-box" align="center">
              <div class="icon"><i class="bi bi-laptop"></i></div>
              <h4 class="title"><a href="">Kewajiban Konsumen</a></h4>
              <p class="description">Anggota harus terdaftar pada database dengan mengisi Biodata dan telah menyetujui semua kesepakatan kerjasama dengan WarungRakyat.</p>
            </div>
          </div>
          </div>
		  <div class="row no-gutters">
          <div class="col-lg-12 col-md-12">
            <div class="icon-box" align="center">
              <div class="icon"><i class="bi bi-laptop"></i></div>
              <h4 class="title"><a href="">Hak Konsumen</a></h4>
              <p class="description">Anggota akan menerima layanan sesuai dengan semua kesepakatan kerjasama dengan WarungRakyat yang telah disetujui.</p>
            </div>
          </div>
          </div>
        </div>
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="credits">
        ...
        Designed by <a href="#team">Tim Naighbor Shop</a>
      </div>
    </div>
  </footer><!-- End Footer -->
