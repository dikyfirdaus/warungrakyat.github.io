...
<body>
 ...
 <div class="container" style="margin-top: 10px">
	...
	<br/>
	<br/>
	<h3>LIHAT PRODUK YANG DITAWARKAN</h3>
	<form method="GET" action="penawaran_aksi.php">
	<a href="kembali.php?id=<?php echo $q['nik'];?>" class="btn btn-md btn-success" style="margin-bottom: 10px">Exit</a >
	<div class="card-body">
                  <div class="row">
	<div class="col-md-12">
		  <div class="form-group ">
				<div>
                  <label> NIK Anda</label>
				   <input type="text" name="nik" value=<?php echo $q['nik'];?> readonly class="form-control">
